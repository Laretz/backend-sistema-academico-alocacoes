...
export interface HorariosRepository {
    ...
    findMany(page?: number, regime?: 'SUPERIOR' | 'TECNICO'): Promise<Horario[]>
    findManyWithFilters(params: { page: number; limit: number; regime?: 'SUPERIOR' | 'TECNICO'; dia_semana?: string }): Promise<{ horarios: Horario[]; total: number }>
